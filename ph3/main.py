...
def expected_json_dump():
    ...
    with open("testcases/testResults.txt") as f_in: # LOAD FILE IN
        data = f_in.readlines()
...
for case in CASES:
    try:
        ...
        subprocess.call(f"make test{case}",shell=True, stderr=subprocess.DEVNULL,stdout=subprocess.DEVNULL)
        ...
        if differnt == True:
            ...
            myCasesJson[case] = {"DIF": exCasesDifJson,"MINE": myCaseOut,"HIS": newexCasesJson}
